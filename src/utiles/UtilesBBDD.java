...
public class UtilesBBDD {


	
	/**
	 * Método que comprueba si un registro determinado existe en la tabla seleccionada. Si existe te 
	 ...
	 * @throws SQLException
	 */
	public static boolean existeIdEnTabla(Connection conn, int id, String nameTable) throws SQLException {
		
		Statement s = conn.createStatement();
		ResultSet rs = s.executeQuery("select * from " + nameTable + " where id = " + id);
